...
----bar widget
bat_widget = {}
bat_widget.bar = awful.widget.progressbar()
bat_widget.bar:set_width(8)
bat_widget.bar:set_vertical(true)
bat_widget.bar:set_background_color ("#494B4F")
bat_widget.bar:set_color ("#ff0000")
...
function update_battery(widget)
	...
	bat_widget.bar:set_value(batt_progress)
